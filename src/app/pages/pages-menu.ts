...
export const menuItems: NbMenuItem[] = [
    ...
    },
    {
      ...
      link: '/pages/product',           // Adjust this to match the correct route for Products
    },
    {
      title: 'Service',
      icon: 'settings-2-outline', // Eva icon for service management
      link: '/pages/service',             // Adjust this to match the correct route for Service
    },
    {
      title: 'Client',
      icon: 'person-done-outline', // Eva icon for clients
      link: '/pages/client',              // Adjust this to match the correct route for Client
    },
    {
      title: 'Appointment / Booking',
      icon: 'calendar-outline',    // Eva icon for appointment or booking
      link: '/pages/booking',               // Adjust this to match the correct route for Appointment/Booking
    }
]